...
{
	//TODO get variables
	var jsonPayload = '{"dateTime" : "' + dateTime + '", "name" : "' + name + '", "description" : "' + description + '", "duration" : "' + duration + '", "completion" : "' + completion + '"}';
...
{
	//TODO get variables
	var jsonPayload = '{"oldDateTime" : "' + oldDateTime + '", "oldName" : "' + oldName + '", "oldDescription" : "' + oldDescription + '", "oldDuration" : "' + oldDuration + '", "oldCompletion" : "' + oldCompletion + '", "newDateTime" : "' + newDateTime + '", "newName" : "' + newName + '", "newDescription" : "' + newDescription + '", "newDuration" : "' + newDuration + '", "newCompletion" : "' + newCompletion + '"}';
	var url = urlBase + '/Modify.' + extension;
	//TODO send request
}
